...
OWNER_USERNAME = getenv("OWNER_USERNAME","VM_COOL")
...
EVALOP = list(map(int, getenv("EVALOP", "6358262816").split()))
...
GIT_TOKEN = getenv(
    "GIT_TOKEN", "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")  # Fill this variable if your upstream repository is private
