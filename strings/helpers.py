...
❍ /mention ᴏʀ @all ➠ '(ʀᴇᴘʟʏ ᴛᴏ ᴍᴇssᴀɢᴇ ᴏʀ ᴀᴅᴅ ᴀɴᴏᴛʜᴇʀ ᴍᴇssᴀɢᴇ) ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴡɪᴛʜᴏᴜᴛ ᴇxᴄᴇᴘᴛɪᴏɴ.
❍ /mentionoff ➠ ғᴏʀ sᴛᴏᴘ ᴛʜɪs ᴛᴀɢɢ

😏😏😏sᴏᴍᴇ sᴘᴇᴄɪᴀʟ ᴛᴀɢɢs 😏😏😏

⦿ ᴜsᴇ ( / ,@ ,# ) ғᴏʀ ᴛʜᴇsᴇ ᴄᴏᴍᴍᴀɴᴅs

 🕯ᴛᴏ ʀᴜɴ🕯  ➠  🕯ᴛᴏ sᴛᴏᴘ🕯
❍ /gntag      ❍/gnstop
❍ /gmtag      ❍/gmstop
❍ /hitag      ❍/histop ᴏʀ cancel
❍ /lifetag    ❍/lifestop ᴏʀ cancel
❍ /tagall     ❍/cancle
❍ /shayari    ❍/shstop ᴏʀ shyarioff
"""
...
⦿ /wel ᴏɴ/ᴏғғ ➠ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ ғᴏʀ ɴᴇᴡ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs.
...
⦿ /nightmode ᴏɴ/ᴏғғ ➠ ʀᴀᴀᴛ 12 ʙᴀᴊᴇ ʙᴀᴀᴅ ᴍᴇᴍʙᴇʀs ɢʀᴏᴜᴘ ᴍ ᴍᴇssᴇɢᴇ, sᴛɪᴋᴇʀs ɴᴀʜɪ sᴇɴᴅ ᴋᴀʀ ᴘᴀʏᴇɴɢᴇ ᴛᴀᴋɪ ɢʀᴏᴜᴘ sᴀғᴇ ʀᴀʜᴇ ᴋᴜᴄʜ ᴄʜᴜᴛɪʏᴏ sᴇ sᴜʙᴀʜ 6 ʙᴀᴊᴛᴇ ʜɪ ᴀɢᴀɪɴ sᴀʀᴇ ᴍᴇᴍʙᴇʀs ɢʀᴏᴜᴘ ᴍ ᴍᴇssᴇɢᴇ ᴋᴀʀ sᴀᴋᴛᴇ ʜ.
"""
HELP_21 = """
<b><u>Exᴛʀᴀ :</b></u>
...
⦿ /genpw ➠ ɢᴇɴʀᴀᴛᴇ ᴘᴀssᴡᴏʀᴅ
⦿ /write ➠ ᴡʀɪᴛᴇ ᴡʜᴀᴛᴇᴠᴇʀ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴡʀɪᴛᴇ
⦿ /couples ➠ sᴇʟᴇᴄᴛ ᴀɴʏ ᴛᴡᴏ ᴘᴇᴏᴘʟᴇs ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ᴀs ᴀ ᴄᴏᴜᴘʟᴇs
⦿ /love ➠ ᴇxᴀᴍᴘʟᴇ - /love ɴᴀʀᴜᴛ ʜɪɴᴀᴛᴀ {ʙᴏᴛ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴘᴇʀᴄᴇɴᴛᴀɢᴇ ʜᴏᴡ ᴍᴜᴄʜ ᴛʜᴇʏ (ɴɪʙʙᴀ - ɴɪʙʙɪ) ʟᴏᴠᴇ ᴇᴀᴄʜ ᴏᴛʜᴇʀ}
...
💀- ᴛʜᴇsᴇ ᴄᴏᴍᴍᴀɴᴅs ɢɪᴠᴇ ᴘᴇʀsᴇɴᴛᴀɢᴇ ʜᴏᴡ ᴛʜᴀʀᴋɪ ʏᴏᴜ ᴀʀᴇ.
...
__
𝐒ᴘᴇᴄɪᴀʟ 𝐂ᴏᴍᴍᴀɴᴅs 𝐒ᴜᴘᴘᴏʀᴛ 𝐀ʟʟ 𝐄xᴀᴍᴘʟᴇ  - baby 𝚋𝚊𝚗 Baby 𝚖𝚞𝚝𝚎 baby 𝚙𝚛𝚘𝚖𝚘𝚝𝚎, kick,..... 𝚎𝚝𝚌
"""
HELP_24 = """
<b><u>Sᴇᴀʀᴄʜ :</b></u>
Available commands:
